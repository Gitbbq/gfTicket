 ...
 *   https://datatables.net/download/#bs/dt-1.10.9,b-1.0.3,b-print-1.0.3,cr-1.2.0,fc-3.1.0,fh-3.0.0,kt-2.0.0,r-1.0.7,rr-1.0.0,sc-1.3.0,se-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.9, Buttons 1.0.3, Print view 1.0.3, ColReorder 1.2.0, FixedColumns 3.1.0, FixedHeader 3.0.0, KeyTable 2.0.0, Responsive 1.0.7, RowReorder 1.0.0, Scroller 1.3.0, Select 1.0.1
 */
    ...
    var S = function (h) {
        ...
        function fb(a) {
            if (!m.__browser) {
                ...
                m.__browser = b;
                var c =
                    h("<div/>").css({position: "fixed", top: 0, left: 0, height: 1, width: 1, overflow: "hidden"}).append(h("<div/>").css({
                        position: "absolute",
                        top: 1,
                        left: 1,
                        width: 100,
            ...
            for (j = c.length; f < j; f++) {
                ...
                for (e = d.firstChild; e;) {
                    if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) {
                        ...
                        n = g;
                        q = 1 === l ? !0 : !1;
                        for (i = 0; i < l; i++)for (g = 0; g < r; g++)a[f + g][n + i] = {cell: e, unique: q}, a[f + g].nTr = d
                    }
                    e = e.nextSibling
                }
            }
...
jQuery.fn.dataTable.ext.builder = "bs\/dt-1.10.9,b-1.0.3,b-print-1.0.3,cr-1.2.0,fc-3.1.0,fh-3.0.0,kt-2.0.0,r-1.0.7,rr-1.0.0,sc-1.3.0,se-1.0.1";
    ...
    var p = function (e, j) {
        ...
        e.extend(l.prototype, {
            ...
            name: function () {
                ...
                b.conf.destroy && b.conf.destroy.call(c.button(a), c, b, b.conf), b.node.remove(), this._removeKey(b.conf), this.s.buttons[1 * a] = null; else {
                    var d = a.split("-");
                ...
                for (var f = 0, g = a.length; f < g; f++) {
                    ...
                    if (h)if (e.isArray(h))this._buildButtons(h,
                        b, c); else {
                        var i = this._buildButton(h, c !== m ? !0 : !1);
                        if (i) {
                            var q = i.node;
                            b.append(i.inserter);
                            c === m ? (this.s.buttons.push({node: q, conf: h, inserter: i.inserter}), this.s.subButtons.push([])) : this.s.subButtons[c].push({
                                node: q,
                                conf: h,
                                inserter: i.inserter
                            });
                ...
                var c = this.c.dom.button, d = this.c.dom.buttonLiner, f =
                    this.c.dom.collection, g = this.s.dt, h = function (b) {
                ...
                if (a.key) {
                    var b =
                        e.isPlainObject(a.key) ? a.key.key : a.key, a = this.s.listenKeys.split(""), b = e.inArray(b, a);
                    a.splice(b, 1);
        ...
        l.buttonSelector = function (a, b) {
            for (var c = [], d = function (a, b) {
                ...
                } else if ("number" === typeof a)c.push({inst: b, idx: a}); else if ("string" === typeof a)if (-1 !== a.indexOf(",")) {
                    var k = a.split(",");
                    f = 0;
...
(function (f, h) {
    ...
    h.ext.buttons.print = {
        className: "buttons-print", text: function (b) {
            ...
            g = function (a, b) {
                for (var i = "<tr>", c = 0, d = a.length; c < d; c++)i += "<" + b + ">" + a[c] + "</" + b + ">";
                return i + "</tr>"
            };
            ...
            var e = window.open("", ""), b = c.title.replace("*", f("title").text());
            e.document.close();
            var k = "<title>" + b + "</title>";
            f("style, link").each(function () {
                var a = k, b = f(this).clone()[0], c;
                "link" === b.nodeName.toLowerCase() && (d.href = b.href, c = d.host, -1 === c.indexOf("/") && 0 !== d.pathname.indexOf("/") && (c += "/"), b.href = d.protocol + "//" + c + d.pathname + d.search);
                k = a + b.outerHTML
            });
...
(function (n, p, r) {
    function o(d) {
        for (var h = [], g = 0, a = d.length; g < a; g++)h[d[g]] = g;
        return h
    }
    ...
    function q(d, h, g) {
        for (var a = [], c = 0, e = d.childNodes.length; c < e; c++)1 == d.childNodes[c].nodeType && a.push(d.childNodes[c]);
        h = a[h];
        null !== g ? d.insertBefore(h, a[g]) : d.appendChild(h)
    }

    n = function (d, h) {
        d.fn.dataTableExt.oApi.fnColReorder = function (a, c, e) {
            var b, f, k, g, h = a.aoColumns.length, i, j;
            i = function (a, b, c) {
            ...
            if (c != e)if (0 > c || c >= h)this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + c); else if (0 > e || e >= h)this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " + e); else {
                k = [];
                b = 0;
                for (f = h; b < f; b++)k[b] = b;
                m(k, c, e);
                var l = o(k);
                b = 0;
                for (f = a.aaSorting.length; b < f; b++)a.aaSorting[b][0] = l[a.aaSorting[b][0]];
                if (null !== a.aaSortingFixed) {
                    b = 0;
                    for (f = a.aaSortingFixed.length; b < f; b++)a.aaSortingFixed[b][0] = l[a.aaSortingFixed[b][0]]
                }
                b = 0;
                for (f = h; b < f; b++) {
                    j = a.aoColumns[b];
                    k = 0;
                    for (g = j.aDataSort.length; k < g; k++)j.aDataSort[k] = l[j.aDataSort[k]];
                    j.idx = l[j.idx]
                }
                d.each(a.aLastSort, function (b, c) {
                    a.aLastSort[b].src = l[c.src]
                });
                b = 0;
                for (f = h; b < f; b++)j = a.aoColumns[b], "number" == typeof j.mData ? (j.mData = l[j.mData], a.oApi._fnColumnOptions(a, b, {})) : d.isPlainObject(j.mData) && (i(j.mData, "_", l), i(j.mData, "filter", l), i(j.mData, "sort", l), i(j.mData, "type", l), a.oApi._fnColumnOptions(a, b, {}));
                if (a.aoColumns[c].bVisible) {
                    k = this.oApi._fnColumnIndexToVisible(a, c);
                    g = null;
                    for (b = e < c ? e : e + 1; null ===
                    g && b < h;)g = this.oApi._fnColumnIndexToVisible(a, b), b++;
                    i = a.nTHead.getElementsByTagName("tr");
                    b = 0;
                    for (f = i.length; b < f; b++)q(i[b], k, g);
                    if (null !== a.nTFoot) {
                    ...
                    b = 0;
                    for (f = a.aoData.length; b < f; b++)null !== a.aoData[b].nTr && q(a.aoData[b].nTr, k, g)
                }
                m(a.aoColumns, c, e);
                m(a.aoPreSearchCols, c, e);
                b = 0;
                for (f = a.aoData.length; b < f; b++)i = a.aoData[b], i.anCells && m(i.anCells, c, e), "dom" !== i.src && d.isArray(i._aData) && m(i._aData, c, e);
                b = 0;
                for (f = a.aoHeader.length; b <
                f; b++)m(a.aoHeader[b], c, e);
                if (null !== a.aoFooter) {
                    b = 0;
                    for (f = a.aoFooter.length; b < f; b++)m(a.aoFooter[b], c, e)
                }
                (new d.fn.dataTable.Api(a)).rows().invalidate();
                b = 0;
                for (f = h; b < f; b++)d(a.aoColumns[b].nTh).off("click.DT"), this.oApi._fnSortAttachListener(a, a.aoColumns[b].nTh, b);
                d(a.oInstance).trigger("column-reorder.dt", [a, {from: c, to: e, mapping: l, iFrom: c, iTo: e, aiInvertMapping: l}])
            }
        };
        var g = function (a, c) {
            var e = (new d.fn.dataTable.Api(a)).settings()[0];
            if (e._colReorder)return e._colReorder;
            !0 === c && (c = {});
            var b =
                d.fn.dataTable.camelToHungarian;
            b && (b(g.defaults, g.defaults, !0), b(g.defaults, c || {}));
            this.s = {
                dt: null,
                init: d.extend(!0, {}, g.defaults, c),
                fixed: 0,
                fixedRight: 0,
        ...
        g.prototype = {
            fnReset: function () {
                ...
                var a = this, c = this.s.dt.aoColumns.length, e = this.s.dt.nTable, b;
                ...
                for (b = 0; b < c; b++)b > this.s.fixed - 1 && b < c - this.s.fixedRight && this._fnMouseListener(b, this.s.dt.aoColumns[b].nTh), this.s.dt.aoColumns[b]._ColReorder_iOrigCol = b;
                ...
                this.s.dt.oLoadedState && ("undefined" != typeof this.s.dt.oLoadedState.ColReorder && this.s.dt.oLoadedState.ColReorder.length == this.s.dt.aoColumns.length) && (f = this.s.dt.oLoadedState.ColReorder);
                if (f)if (a.s.dt._bInitComplete)c = o(f), a._fnOrderColumns.call(a, c); else {
                    var g = !1;
                    d(e).on("draw.dt.colReorder", function () {
                ...
                d(e).on("destroy.dt.colReorder", function () {
                    d(e).off("destroy.dt.colReorder draw.dt.colReorder");
                    d(a.s.dt.nTHead).find("*").off(".ColReorder");
                ...
                if (a.length != this.s.dt.aoColumns.length)this.s.dt.oInstance.oApi._fnLog(this.s.dt, 1, "ColReorder - array reorder does not match known number of columns. Skipping."); else {
                    for (var c = 0, e = a.length; c < e; c++) {
                        var b = d.inArray(c, a);
                        c != b && (m(a, b, c), this.s.dt.oInstance.fnColReorder(b, c))
                    }
                    ("" !== this.s.dt.oScroll.sX || "" !==
                    this.s.dt.oScroll.sY) && this.s.dt.oInstance.fnAdjustColumnSizing(!1);
                    this.s.dt.oInstance.oApi._fnSaveState(this.s.dt);
                    this._fnSetColumnIndexes();
                    null !== this.s.reorderCallback && this.s.reorderCallback.call(this)
                }
            }, _fnStateSave: function (a) {
                var c, e, b, f = this.s.dt.aoColumns;
                a.ColReorder = [];
                if (a.aaSorting) {
                    for (c = 0; c < a.aaSorting.length; c++)a.aaSorting[c][0] = f[a.aaSorting[c][0]]._ColReorder_iOrigCol;
                    var g = d.extend(!0, [], a.aoSearchCols);
                    c = 0;
                    for (e = f.length; c < e; c++)b = f[c]._ColReorder_iOrigCol, a.aoSearchCols[b] =
                        g[c], a.abVisCols[b] = f[c].bVisible, a.ColReorder.push(b)
                } else if (a.order) {
                    for (c = 0; c < a.order.length; c++)a.order[c][0] = f[a.order[c][0]]._ColReorder_iOrigCol;
                    g = d.extend(!0, [], a.columns);
                    c = 0;
                    for (e = f.length; c < e; c++)b = f[c]._ColReorder_iOrigCol, a.columns[b] = g[c], a.ColReorder.push(b)
                }
            }, _fnMouseListener: function (a, c) {
                var e = this;
                d(c).on("mousedown.ColReorder", function (a) {
                    a.preventDefault();
                    e._fnMouseDown.call(e, a, c)
                })
            }, _fnMouseDown: function (a, c) {
                var e = this, b = d(a.target).closest("th, td").offset(), f = parseInt(d(c).attr("data-column-index"),
                    10);
                f !== r && (this.s.mouse.startX = a.pageX, this.s.mouse.startY = a.pageY, this.s.mouse.offsetX = a.pageX - b.left, this.s.mouse.offsetY = a.pageY - b.top, this.s.mouse.target = this.s.dt.aoColumns[f].nTh, this.s.mouse.targetIndex = f, this.s.mouse.fromIndex = f, this._fnRegions(), d(p).on("mousemove.ColReorder", function (a) {
                ...
                if (null === this.dom.drag) {
                    if (5 > Math.pow(Math.pow(a.pageX - this.s.mouse.startX, 2) + Math.pow(a.pageY -
                                this.s.mouse.startY, 2), 0.5))return;
                    this._fnCreateDragNode()
                }
                this.dom.drag.css({left: a.pageX - this.s.mouse.offsetX, top: a.pageY - this.s.mouse.offsetY});
                for (var c = !1, d = this.s.mouse.toIndex, b = 1, f = this.s.aoTargets.length; b < f; b++)if (a.pageX < this.s.aoTargets[b - 1].x + (this.s.aoTargets[b].x - this.s.aoTargets[b - 1].x) / 2) {
                    this.dom.pointer.css("left", this.s.aoTargets[b - 1].x);
                    this.s.mouse.toIndex = this.s.aoTargets[b - 1].to;
                    c = !0;
                    break
                }
                c || (this.dom.pointer.css("left", this.s.aoTargets[this.s.aoTargets.length - 1].x), this.s.mouse.toIndex =
                    this.s.aoTargets[this.s.aoTargets.length - 1].to);
                this.s.init.bRealtime && d !== this.s.mouse.toIndex && (this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex, this.s.mouse.toIndex), this.s.mouse.fromIndex = this.s.mouse.toIndex, this._fnRegions())
            }, _fnMouseUp: function () {
                d(p).off("mousemove.ColReorder mouseup.ColReorder");
                null !== this.dom.drag && (this.dom.drag.remove(), this.dom.pointer.remove(), this.dom.drag = null, this.dom.pointer = null, this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex, this.s.mouse.toIndex),
                    this._fnSetColumnIndexes(), ("" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY) && this.s.dt.oInstance.fnAdjustColumnSizing(!1), this.s.dt.oInstance.oApi._fnSaveState(this.s.dt), null !== this.s.reorderCallback && this.s.reorderCallback.call(this))
            }, _fnRegions: function () {
                var a = this.s.dt.aoColumns;
                this.s.aoTargets.splice(0, this.s.aoTargets.length);
                this.s.aoTargets.push({x: d(this.s.dt.nTable).offset().left, to: 0});
                for (var c = 0, e = 0, b = a.length; e < b; e++)e != this.s.mouse.fromIndex && c++, a[e].bVisible && this.s.aoTargets.push({
                    x: d(a[e].nTh).offset().left +
                    d(a[e].nTh).outerWidth(), to: c
                });
                ...
                var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY, c = this.s.dt.aoColumns[this.s.mouse.targetIndex].nTh, e = c.parentNode, b = e.parentNode, f = b.parentNode, g = d(c).clone();
                this.dom.drag = d(f.cloneNode(!1)).addClass("DTCR_clonedTable").append(d(b.cloneNode(!1)).append(d(e.cloneNode(!1)).append(g[0]))).css({
                    position: "absolute",
                    top: 0, left: 0, width: d(c).outerWidth(), height: d(c).outerHeight()
                }).appendTo("body");
                ...
                d.each(this.s.dt.aoColumns, function (a, c) {
                    d(c.nTh).attr("data-column-index", a)
                })
            }
        };
        g.defaults =
        {aiOrder: null, bRealtime: !0, iFixedColumnsLeft: 0, iFixedColumnsRight: 0, fnReorderCallback: null};
        g.version = "1.2.0";
        d.fn.dataTable.ColReorder = g;
        d.fn.DataTable.ColReorder = g;
        "function" == typeof d.fn.dataTable && "function" == typeof d.fn.dataTableExt.fnVersionCheck && d.fn.dataTableExt.fnVersionCheck("1.10.8") ? d.fn.dataTableExt.aoFeatures.push({
            fnInit: function (a) {
                var c = a.oInstance;
                a._colReorder ? c.oApi._fnLog(a, 1, "ColReorder attempted to initialise twice. Ignoring second") : (c = a.oInit, new g(a, c.colReorder || c.oColReorder ||
                    {}));
                return null
            }, cFeature: "R", sFeature: "ColReorder"
        }) : alert("Warning: ColReorder requires DataTables 1.10.8 or greater - www.datatables.net/download");
        d(p).on("preInit.dt.colReorder", function (a, c) {
            if ("dt" === a.namespace) {
                var e = c.oInit.colReorder, b = h.defaults.colReorder;
                if (e || b)b = d.extend({}, e, b), !1 !== e && new g(c, b)
            }
        });
    ...
    "function" === typeof define && define.amd ? define(["jquery", "datatables"], n) : "object" === typeof exports ? n(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.ColReorder && n(jQuery, jQuery.fn.dataTable)
})(window, document);
...
(function (s, t, u) {
    var r = function (d, q) {
        ...
        m.prototype = {
            fnUpdate: function () {
                ...
                if (d(a).parents(".DTFC_Cloned").length) {
                    ...
                    return [b.fnGetPosition(d("tr", this.s.dt.nTBody)[a]), c, b.oApi._fnVisibleToColumnIndex(this.s.dt,
                        c)]
                }
                ...
                if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0"))alert("FixedColumns " + m.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation"); else if ("" === this.s.dt.oScroll.sX)this.s.dt.oInstance.oApi._fnLog(this.s.dt, 1, "FixedColumns is not needed (no x-scrolling in DataTables enabled), so no action will be taken. Use 'FixedHeader' for column fixing when scrolling is not enabled");
                    ...
                    d(this.dom.scroller).on("mouseover.DTFC touchstart.DTFC", function () {
                        ...
                        if ("main" === c && (0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.scroller.scrollTop), 0 < b.s.iRightColumns))b.dom.grid.right.liner.scrollTop =
                            b.dom.scroller.scrollTop
                    });
                    var e = "onwheel" in t.createElement("div") ? "wheel.DTFC" : "mousewheel.DTFC";
                    ...
                    g.on("draw.dt.DTFC", function () {
                        ...
                        d(s).off("resize.DTFC");
                        d(b.dom.grid.left.liner).off("mouseover.DTFC touchstart.DTFC scroll.DTFC " +
                            e);
                ...
                d.each(this.s.dt.aoColumns, function (e, f) {
                    ...
                    if (g.filter(":visible").length) {
                        var i = g.outerWidth();
                        0 === a.s.aiOuterWidths.length && (h = d(a.s.dt.nTable).css("border-left-width"), i += "string" === typeof h ?
                            1 : parseInt(h, 10));
                ...
                for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
                    ...
                    for (var l = 0, p = this.s.iTableColumns; l < p; l++)if (-1 !== d.inArray(l, b)) {
                        var o = d.inArray(a[h][l].cell, g);
                        -1 === o ? (o = d(a[h][l].cell).clone(c, !1)[0], f.push(o), g.push(a[h][l].cell), k.push({cell: o, unique: a[h][l].unique})) : k.push({
                            cell: f[o],
                            unique: a[h][l].unique
                        })
                    }
                ...
                var f = this, g, h, i, k, l, p, o, n, m, j = this.s.dt;
                if (e) {
                    d(a.header).remove();
                ...
                if (0 < j.aiDisplay.length) {
                    h =
                        d(">thead>tr", a.body)[0];
                    for (o = 0; o < c.length; o++)l = c[o], p = d(j.aoColumns[l].nTh).clone(!0)[0], p.innerHTML = "", k = p.style, k.paddingTop = "0", k.paddingBottom = "0", k.borderTopWidth = "0", k.borderBottomWidth = "0", k.height = 0, k.width = f.s.aiInnerWidths[l] + "px", h.appendChild(p);
                    ...
                    p.className = p.className + " DTFC_NoData";
                    d("td", p).html("");
                    q.appendChild(p)
                });
                ...
                j.oScroller !== u && (h = j.oScroller.dom.force, b.forcer ? b.forcer.style.height = h.style.height : (b.forcer = h.cloneNode(!0), b.liner.appendChild(b.forcer)));
        ...
        m.version = "3.1.0";
        q.Api.register("fixedColumns()", function () {
            return this
        });
        q.Api.register("fixedColumns().update()", function () {
            return this.iterator("table", function (a) {
                a._oFixedColumns && a._oFixedColumns.fnUpdate()
            })
        });
        q.Api.register("fixedColumns().relayout()", function () {
            return this.iterator("table", function (a) {
                a._oFixedColumns && a._oFixedColumns.fnRedrawLayout()
            })
        });
        q.Api.register("rows().recalcHeight()",
            function () {
                return this.iterator("row", function (a, b) {
                    a._oFixedColumns && a._oFixedColumns.fnRecalculateHeight(this.row(b).node())
                })
            });
        q.Api.register("fixedColumns().rowIndex()", function (a) {
            a = d(a);
            return a.parents(".DTFC_Cloned").length ? this.rows({page: "current"}).indexes()[a.index()] : this.row(a).index()
        });
        q.Api.register("fixedColumns().cellIndex()", function (a) {
            a = d(a);
        ...
        d(t).on("init.dt.fixedColumns", function (a, b) {
            if ("dt" === a.namespace) {
                var c = b.oInit.fixedColumns, e = q.defaults.fixedColumns;
...
(function (h, j) {
    var g = function (e, i) {
        var g = 0, f = function (b, a) {
            ...
            this.s = {
                dt: b,
                position: {theadTop: 0, tbodyTop: 0, tfootTop: 0, tfootBottom: 0, width: 0, left: 0, tfootHeight: 0, theadHeight: 0, windowHeight: e(h).height(), visible: !0},
                headerMode: null,
                footerMode: null,
                namespace: ".dtfc" + g++
            };
...
(function (n, l, o) {
    var m = function (f, g) {
        var j = function (a, b) {
            ...
            this.c = f.extend(!0, {}, g.defaults.keyTable, j.defaults, b);
        ...
        j.prototype = {
            blur: function () {
                ...
                this._tabInput();
                var a = this, b = this.s.dt, d = f(b.table().node());
                ...
                f(l.body).on("keydown.keyTable", function (c) {
                    a._key(c)
                });
                if (this.c.blurable)f(l.body).on("click.keyTable", function (c) {
                ...
                if (this.c.editor)b.on("key.kt", function (c, b, d, f, i) {
                    a._editor(d, i)
                });
                if (b.settings()[0].oFeatures.bStateSave)b.on("stateSaveParams.keyTable", function (c, b, d) {
                    d.keyTable = a.s.lastFocus ? a.s.lastFocus.index() : null
                });
                b.on("destroy.keyTable", function () {
                    b.off(".keyTable");
                    f(b.table().body()).off("click.keyTable", "th, td");
                    f(l.body).off("keydown.keyTable").off("click.keyTable")
                });
                (d = b.state.loaded()) && d.keyTable ? b.cell(d.keyTable).focus() : this.c.focus && b.cell(this.c.focus).focus()
            }, _blur: function () {
                if (this.s.enable &&
                    this.s.lastFocus) {
                ...
                var e = f("div.DTE input");
                e.length && e[0].select();
                d.keys.enable("navigation-only");
                d.one("key-blur.editor",
                    function () {
                ...
                var d = this, c = this.s.dt, e = c.page.info(), k = this.s.lastFocus;
                if (this.s.enable) {
                    if ("number" !== typeof a) {
                        var h = a.index(), b = h.column, a = c.rows({filter: "applied", order: "applied"}).indexes().indexOf(h.row);
                        e.serverSide && (a += e.start)
                    }
                    if (a < e.start || a >= e.start + e.length)c.one("draw",
                        function () {
                            d._focus(a, b)
                        }).page(Math.floor(a / e.length)).draw(!1); else if (-1 !== f.inArray(b, this._columns())) {
                        e.serverSide && (a -= e.start);
                        e = c.cell(":eq(" + a + ")", b);
                        if (k) {
                            if (k.node() === e.node())return;
                            this._blur()
                        }
                        k = f(e.node());
                        k.addClass(this.c.className);
                        this._scroll(f(n), f(l.body), k, "offset");
                        h = c.table().body().parentNode;
                        h !== c.table().header().parentNode && (h = f(h.parentNode), this._scroll(h, h, k, "position"));
                        this.s.lastFocus = e;
                ...
                if (this.s.enable && !(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey)) {
                    ...
                    if (b) {
                        ...
                        if (!(this.c.keys && -1 === f.inArray(a.keyCode, this.c.keys)))switch (a.keyCode) {
                            ...
                            case 34:
                                a.preventDefault();
                                var e = c.cells({page: "current"}).nodes().indexOf(b.node());
                                c.one("draw", function () {
                ...
                var c = d[c](), e = d.outerHeight(), d = d.outerWidth(), f = b.scrollTop(), h = b.scrollLeft(),
                    i = a.height(), a = a.width();
                ...
                var c = this.s.dt, e = c.page.info(), f = e.recordsDisplay, h = this.s.lastFocus, i = this._columns();
                if (h) {
                    var g = c.rows({filter: "applied", order: "applied"}).indexes().indexOf(h.index().row);
                    e.serverSide && (g += e.start);
                    c = c.columns(i).indexes().indexOf(h.index().column);
                    e = i[c];
                    "right" === b ? c >= i.length - 1 ? (g++, e = i[0]) : e = i[c + 1] : "left" ===
                    b ? 0 === c ? (g--, e = i[i.length - 1]) : e = i[c - 1] : "up" === b ? g-- : "down" === b && g++;
                    0 <= g && g < f && 0 <= e && e <= i.length ? (a.preventDefault(), this._focus(g, e)) : !d || !this.c.blurable ? a.preventDefault() : this._blur()
                }
            }, _tabInput: function () {
                ...
                if (-1 != d)f('<div><input type="text" tabindex="' + d + '"/></div>').css({
                    ...
                    a._focus(b.cell(":eq(0)",
                        {page: "current"}))
                })
            }
        };
        j.defaults = {blurable: !0, className: "focus", columns: "", editor: null, focus: null, keys: null, tabIndex: null};
        j.version = "2.0.0";
        f.fn.dataTable.KeyTable = j;
        f.fn.DataTable.KeyTable = j;
        ...
        f(l).on("preInit.dt.dtk", function (a, b) {
            if ("dt" === a.namespace) {
                var d = b.oInit.keys, c = g.defaults.keys;
                if (d || c)c = f.extend({}, d, c), !1 !== d && new j(b, c)
            }
        });
        return j
    };
    "function" === typeof define && define.amd ? define(["jquery", "datatables"], m) : "object" === typeof exports ? m(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.KeyTable &&
    m(jQuery, jQuery.fn.dataTable)
})(window, document);
...
(function (n, p) {
    var o = function (e, k) {
        ...
        h.breakpoints = [{name: "desktop", width: Infinity}, {name: "tablet-l", width: 1024}, {name: "tablet-p", width: 768}, {name: "mobile-l", width: 480}, {
            name: "mobile-p",
            width: 320
        }];
        h.defaults = {
...
(function (l, i) {
    var k = function (e, h) {
        var g = function (b, a) {
            ...
            this.c = e.extend(!0, {}, h.defaults.rowReorder, g.defaults, a);
            this.s = {
                bodyTop: null,
                dt: new h.Api(b),
        ...
        g.prototype = {
            _constructor: function () {
                ...
                "static" === d.css("position") && d.css("position", "relative");
                e(d).on("mousedown.rowReorder touchstart.rowReorder", this.c.selector, function (c) {
                    var d = e(this).closest("tr");
                    if (a.row(d).any())return b._mouseDown(c, d), !1
                });
                a.on("destroy", function () {
                    d.off("mousedown.rowReorder")
                })
            }, _cachePositions: function () {
                var b = this.s.dt, a = e(b.table().node()).find("thead").outerHeight(),
                    d = e.unique(b.rows({page: "current"}).nodes().toArray()), c = e.map(d, function (b) {
                        return e(b).position().top - a
                    }), d = e.map(c, function (a, d) {
                        return c.length < d - 1 ? (a + c[d + 1]) / 2 : (a + a + e(b.row(":last-child").node()).outerHeight()) / 2
                    });
                this.s.middles = d;
                this.s.bodyTop = e(b.table().body()).offset().top;
                this.s.windowHeight = e(l).height()
            }, _clone: function (b) {
                var a = e(this.s.dt.table().node().cloneNode(!1)).addClass("dt-rowReorder-float").append("<tbody/>").append(b.clone(!1)), d = b.outerWidth(), c = b.outerHeight(), f = b.children().map(function () {
                    return e(this).width()
                });
                ...
                this.dom.clone.css({top: d + a.offsetTop, left: !0 === c ? a.offsetLeft : "number" === typeof c ? a.offsetLeft + c : b + a.offsetLeft})
                ...
                return -1 !==
                b.type.indexOf("touch") ? b.originalEvent.touches[0]["page" + a] : b["page" + a]
            }, _mouseDown: function (b, a) {
                var d = this, c = this.s.dt, f = this.s.start, g = a.offset();
                f.top = this._eventToPage(b, "Y");
                f.left = this._eventToPage(b, "X");
                f.offsetTop = g.top;
                f.offsetLeft = g.left;
                f.nodes = e.unique(c.rows({page: "current"}).nodes().toArray());
                this._cachePositions();
                this._clone(a);
                this._clonePosition(b);
                this.dom.target = a;
                a.addClass("dt-rowReorder-moving");
                e(i).on("mouseup.rowReorder touchend.rowReorder", function (a) {
                    d._mouseUp(a)
                }).on("mousemove.rowReorder touchmove.rowReorder",
                    function (a) {
                        d._mouseMove(a)
                    });
                e(l).width() === e(i).width() && e(i.body).addClass("dt-rowReorder-noOverflow")
            }, _mouseMove: function (b) {
                this._clonePosition(b);
                for (var a = this._eventToPage(b, "Y") - this.s.bodyTop, d = this.s.middles, c = null, f = this.s.dt, g = f.table().body(), j = 0, h = d.length; j < h; j++)if (a < d[j]) {
                    c = j;
                    break
                }
                null === c && (c = d.length);
                if (null === this.s.lastInsert || this.s.lastInsert !== c)0 === c ? this.dom.target.prependTo(g) : (a = e.unique(f.rows({page: "current"}).nodes().toArray()), c > this.s.lastInsert ? this.dom.target.before(a[c -
                1]) : this.dom.target.after(a[c])), this._cachePositions(), this.s.lastInsert = c;
                b = this._eventToPage(b, "Y") - i.body.scrollTop;
                c = this.s.scrollInterval;
                65 > b ? c || (this.s.scrollInterval = setInterval(function () {
                    i.body.scrollTop = i.body.scrollTop - 5
                ...
                e(i).off(".rowReorder");
                e(i.body).removeClass("dt-rowReorder-noOverflow");
                var c = this.s.start.nodes, f = e.unique(b.rows({page: "current"}).nodes().toArray()), g = {}, j = [], h = [], k = this.s.getDataFn, l = this.s.setDataFn;
                a = 0;
                for (d = c.length; a < d; a++)if (c[a] !== f[a]) {
                    var m = b.row(f[a]).id(), o = b.row(f[a]).data(), n = b.row(c[a]).data();
                    m && (g[m] = k(n));
                    j.push({node: f[a], oldData: k(o), newData: k(n), newPosition: a, oldPosition: e.inArray(f[a], c)});
                    h.push(f[a])
                }
                this._emitEvent("row-reorder", [j, {dataSrc: this.c.dataSrc, nodes: h, values: g}]);
                this.c.editor && this.c.editor.edit(h, !1, {submit: "changed"}).multiSet(this.c.dataSrc, g).submit();
                if (this.c.update) {
                    a = 0;
                    for (d = j.length; a < d; a++)c = b.row(j[a].node), f = c.data(), l(f, j[a].newData), c.invalidate("data");
                    b.draw(!1)
                }
            }
        };
        g.defaults = {dataSrc: 0, editor: null, selector: "td:first-child", snapX: !1, update: !0};
        g.version = "1.0.0";
        e.fn.dataTable.RowReorder = g;
        e.fn.DataTable.RowReorder = g;
        e(i).on("init.dt.dtr", function (b, a) {
            if ("dt" === b.namespace) {
    ...
    "function" === typeof define && define.amd ? define(["jquery", "datatables"], k) : "object" === typeof exports ? k(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.RowReorder && k(jQuery, jQuery.fn.dataTable)
})(window, document);
...
(function (m, n, k) {
    var j = function (e, j) {
        var g = function (a, b) {
            this instanceof g ? (b === k && (b = {}), this.s = {
                ...
                force: n.createElement("div"), scroller: null, table: null,
                loader: null
        ...
        g.prototype = {
            fnRowToPixels: function (a, b, c) {
                ...
                0 > i && (i = 0);
                if ((f > this.s.redrawBottom || f < this.s.redrawTop) && this.s.dt._iDisplayStart !== i)d = !0, f = this.fnRowToPixels(a, !1, !0);
                ...
                if (!this.s.skip && !this.s.ingnoreScroll)if (this.s.dt.bFiltered ||
                    ...
                    if (c < this.s.redrawTop || c > this.s.redrawBottom) {
                        ...
                        Math.abs(c - this.s.lastScrollTop) > b.viewport || this.s.ani ? (d = parseInt(this._domain("physicalToVirtual", c) / b.row, 10) - f, this.s.topRowFloat = this._domain("physicalToVirtual", c) / b.row) : (d = this.fnPixelsToRow(c) - f, this.s.topRowFloat = this.fnPixelsToRow(c,
                            !1));
                        ...
                        if (d != this.s.dt._iDisplayStart && (this.s.tableTop = e(this.s.dt.nTable).offset().top, this.s.tableBottom = e(this.s.dt.nTable).height() + this.s.tableTop, b = function () {
                                ...
                                this.s.serverWait)) : b(), this.dom.loader && !this.s.loaderVisible))this.dom.loader.css("display", "block"), this.s.loaderVisible = !0
                    }
                ...
                this.s.skip = !0;
                this._fnScrollForce();
                c = 0 === f ? this.s.topRowFloat * b.row : f + i >= g ? b.scroll - (g - this.s.topRowFloat) * b.row : this._domain("virtualToPhysical", this.s.topRowFloat *
                    b.row);
                this.dom.scroller.scrollTop = c;
                this.s.baseScrollTop = c;
                this.s.baseRowTop = this.s.topRowFloat;
                var l = c - (this.s.topRowFloat - f) * b.row;
                0 === f ? l = 0 : f + i >= g && (l = b.scroll - d);
                ...
                this.s.skip = !1;
                this.s.dt.oFeatures.bStateSave && null !== this.s.dt.oLoadedState && "undefined" != typeof this.s.dt.oLoadedState.iScroller ? ((c = (this.s.dt.sAjaxSource ||
                a.s.dt.ajax) && !this.s.dt.oFeatures.bServerSide ? !0 : !1) && 2 == this.s.dt.iDraw || !c && 1 == this.s.dt.iDraw) && setTimeout(function () {
                ...
                if (this.s.dt.oFeatures.bInfo) {
                    var a = this.s.dt, b = a.oLanguage, c = this.dom.scroller.scrollTop, d = Math.floor(this.fnPixelsToRow(c, !1, this.s.ani) + 1), f = a.fnRecordsTotal(), g = a.fnRecordsDisplay(), c = Math.ceil(this.fnPixelsToRow(c + this.s.heights.viewport, !1, this.s.ani)), c = g < c ? g : c, h = a.fnFormatNumber(d), l = a.fnFormatNumber(c), j = a.fnFormatNumber(f),
                    ...
                    if ("undefined" != typeof a) {
                        d = 0;
                        for (f = a.length; d < f; d++)e(a[d]).html(h)
                    }
                }
            }
        };
        ...
        e(n).on("preInit.dt.dtscroller", function (a, b) {
            if ("dt" === a.namespace) {
                var c = b.oInit.scroller, d = j.defaults.scroller;
        ...
        h.register("scroller().rowToPixels()",
            function (a, b, c) {
                var d = this.context;
        ...
        h.register("row().scrollTo()", function (a) {
            ...
            this.iterator("row", function (c, d) {
                if (c.oScroller) {
                    var e =
                        b.rows({order: "applied", search: "applied"}).indexes().indexOf(d);
    ...
    "function" === typeof define && define.amd ? define(["jquery", "datatables"], j) : "object" === typeof exports ? j(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.Scroller && j(jQuery, jQuery.fn.dataTable)
})(window, document);
    ...
    j = function (e, h) {
        ...
        function t(a) {
            ...
            if (c._select.info && c.aanFeatures.i) {
                var b = e('<span class="select-info"/>'), d = function (c, d) {
                    b.append(e('<span class="select-item"/>').append(a.i18n("select." + c + "s", {_: "%d " + c + "s selected", "0": "", 1: "1 " + c + " selected"}, d)))
                };
        ...
        function r(a, c, b, d, g) {
            ...
            "os" === q ? a.ctrlKey || a.metaKey ? c[d](g).select(!f) : a.shiftKey ? "cell" === d ? (d = b._select_lastCell || null, f = function (b, a) {
                ...
                if (d.indexOf(b) > d.indexOf(a))var f = a, a = b, b = f;
                var g = !1;
                return d.filter(function (c) {
                    c === b && (g = !0);
                    return c === a ? (g = !1, !0) : g
                })
            }, !c.cells({selected: !0}).any() && !d ? (f = f(0, g.column), d = a(0, g.row)) : (f = f(d.column, g.column), d = a(d.row, g.row)), d = c.cells(d, f).flatten(), c.cells(g, {selected: !0}).any() ? c.cells(d).deselect() : c.cells(d).select()) :
        ...
        m("select.items()", function (a) {
            return a ===
            i ? this.context[0]._select.items : this.iterator("table", function (c) {
                c._select.items = a;
                ...
                if (!c._select_init) {
                    ...
                    b.on("preXhr.dt.dtSelect", function () {
                        var a = b.rows({selected: !0}).ids(!0).filter(function (b) {
                            ...
                            return a ? {row: a, column: c.column} : i
                        }).filter(function (b) {
                            return b !== i
                        });
        ...
        e.extend(h.ext.buttons, {
            selected: {
                ...
                text: p("selectNone", "Deselect all"), className: "buttons-select-none", action: function () {
                    o(this.settings()[0], !0)
                }
            }
        });
        e.each(["Row", "Column", "Cell"], function (a, c) {
            ...
            h.ext.buttons["select" + c + "s"] = {
                text: p("select" + c + "s", "Select " + b + "s"), className: "buttons-select-" + b + "s", action: function () {
                    this.select.items(b)
                }, init: function (a) {
                    var c =
                        this;
        ...
        e(u).on("init.dt.dtSelect", function (a, c) {
            if ("dt" === a.namespace) {
                ...
                c._select = {};
                if (!0 === b)j = "os"; else if ("string" === typeof b)j = b; else if (e.isPlainObject(b) && (b.blurable !== i && (f = b.blurable), b.info !== i && (k = b.info), b.items !== i && (g = b.items), b.style !== i && (j = b.style), b.selector !== i))l = b.selector;
                d.select.selector(l);
                d.select.items(g);
                d.select.style(j);
                d.select.blurable(f);
